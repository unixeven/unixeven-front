...
export const OurClients: FC<OurClientsProps> = ({ clientsSay: { title } }) => {
  ...
  return (
    <section
      className="w-full py-16 px-4 md:py-20 md:px-28 xl:py-[88px] xl:px-24 bg-our-clients-mobile md:bg-our-clients-tablet xl:bg-our-clients-desktop bg-[center_bottom] bg-no-repeat bg-contain"
