  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'our-clients-mobile': "url('/images/our-clients/bg-mobile.webp')",
        'our-clients-tablet': "url('/images/our-clients/bg-tablet.webp')",
        'our-clients-desktop': "url('/images/our-clients/bg-desktop.webp')",
      },
      backgroundPosition: {
